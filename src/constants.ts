...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    features: ['Non-adhesive, leaves no residue', 'Applied under tension for a tight wrap', 'Durable and moisture-resistant PVC', 'Creates a comfortable, high-friction grip'],
  ...
  // Antistatic & ESD Tapes (10)
  {
    ...
    industries: ['electronic-industry'],
    images: ['https://file.garden/aIULwzQ_QkPKQcGw/polyimide.webp'],
    seo: {
